...
<body data-keyword="${fn:escapeXml(keyword)}" data-default-sort="sales">
	...
	<script src="${pageContext.request.contextPath}/resources/products/script/product_list.js" defer></script>
</body>
</html>