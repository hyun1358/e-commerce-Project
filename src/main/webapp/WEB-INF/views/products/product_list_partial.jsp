...
<c:forEach var="vo" items="${list}" varStatus="status">
	...
	<div class="product-card">
		...
		<button class="compare"
			onclick="addToComparison('${pageContext.request.contextPath}/resources/${vo.image1}', '${fn:escapeXml(vo.product_name)}', '${vo.final_price}', '${vo.product_id}')">
			<span>비교하기</span>
		</button>
	</div>
	<!-- 4개마다 section 닫기 -->
...
<script>
    initializeProductListActions('${pageContext.request.contextPath}');
    initializeCartActions('${pageContext.request.contextPath}');
</script>