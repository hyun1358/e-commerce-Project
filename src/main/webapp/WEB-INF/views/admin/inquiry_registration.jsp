...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/inquiry_registration.css" />
	</head>
	...
	<body>
		...
		<div class="container">
			...
			<div class="inquiry_registration_main">
				<div class="inquiry_registration">
					...
					<table class="customer_answer">
						<tr>
							<td class="table_title">
								<input type="text" name="answerHeader" class="answerHeader">
							</td>			
						</tr>
						<tr>
							<td><textarea name="answerBody" class="answerBody"></textarea></td>
						</tr>
			        </table>
				</div>
