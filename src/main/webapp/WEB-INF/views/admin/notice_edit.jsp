...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/css/notice_edit.css" />
		<script src="${pageContext.request.contextPath}/js/notice_edit.js" defer></script>
	</head>
	...
	<body>
		...
		<div class="container">
			...
			<div class="notice_edit_main">
				<div class="notice_edit">
					<h3 class="notice_text">공지사항 수정</h3>
					<div class="table_wrapper">
				        ...
				        <table class="basicInformation">
							...
							<tr>
								<th>제목</th>
								<td>
									<input type="text" name="noticeName" class="noticeName" value="삼성 노트북 배터리 무상 교환 프로그램 안내">
								</td>
							</tr>
							<tr>
								<th>내용</th>
								<td>
									<textarea name="noticeContent" class="noticeContent">내용 내용 내용 내용 내용</textarea>
								</td>
							</tr>
				        </table>
