...
<script src="${pageContext.request.contextPath}/resources/users/script/review-list-empty.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/users/css/review-list-empty.css" />
					...
					<div id="order-list">
						<c:choose>
						    <c:when test="${empty reviewList}">
						      <div class="no-orders">작성 가능한 구매후기가 없습니다.</div>
						    </c:when>
						    <c:otherwise>
