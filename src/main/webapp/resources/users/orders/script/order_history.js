            ...
            <div class="order-items ${index !== products.length - 1 ? 'with-border' : ''}">
              ...
              <div class="order-info">
                <div class="order-name">
					<a href="product_detail.do?product_id=${ product.product_id }">${product.product_name}</a>
				</div>
              ...
              <div class="order-actions">
                ...
                <button class="action-button state"
                  onclick="location.href='${contextPath}/order/delivery?order_id=${orderId}&product_id=${product.product_id}'">배송상세</button>
              </div>
            </div>
          `;
        });
